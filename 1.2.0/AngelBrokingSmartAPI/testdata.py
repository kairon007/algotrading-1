...
stocks_to_scan2={'ADANIPORTS','ADANIPOWER','ALBK','APOLLOHOSP','ASHOKLEY','ASIANPAINT','AUBANK','AUROPHARMA','AXISBANK','BAJAJ-AUTO','BAJAJHLDNG','BAJFINANCE','BANKINDIA','BATAINIA','BEL','BERGEPAINT','BHARTIARTL','BPCL','BRITANNIA','CANBK','CASTROLIND','CESC','CHOLAFIN','COROMANDEL','CROMPTON','CUMMINSIND','DLF','DRREDDY','EICHERMOT','EAMILTD','FCONSUMER','FRETAIL','GICRE','GLENMARK','GMRINFRA','GODREJAGRO','GODREJCP','GODREJIND','GODREJPROP','GRAPHITE','GRASIM','HCLTECH','HDFC','HDFCLIFE','HEXWARE','HINDPETRO','HINDUNILVR','HINDZINC','IBULHSGFIN','IBVENTURES','ICICIGI','IDEA','IGL','INDIANB','INDIGO','INDUSINDBK','INFY','ITC','JINDALSTEL','JSWENERGY','JUBLFOOD','KOTAKBANK','L&TFH','LICHSGFIN','LUPIN','M&M','MANAPPURAM','MARICO','MARUTI','MFSL','MGL','MINDTREE','MOTHERSUMI','MPHASIS','MRF','MUTHOOTFIN','NATIONAUM','NAUKRI','NESTLEIND','NMDC','NTPC','OIL','ONGC','PAGEIND','PFIZER','PIDILITIND','PIIND','PNBHOUSING','POWERGRID','QUESS','RAMCOCEM','RBLBANK','SAIL','SBILIFE','SBIN','SIMENS','STRTECH','SUNPHARMA','SUNTV','SYNGENE','TATACHEM','TATAMOTORS','TATASTEEL','TCS','TECHM','TITAN','TORNTPHARM','TORNTPOWER','UBL','UNIONBANK','UPL','VARROC','VGUARD','VOLTAS','WIPRO','YESBANK'}
refreshtoken=""

starttime = datetime.now().replace(hour=9, minute=14, second=59, microsecond=0)
endtime = datetime.now().replace(hour=15, minute=21, second=00, microsecond=0)